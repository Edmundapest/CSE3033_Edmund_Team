...
if ( hour > 12 ) {
  ...
  if ( hour == 12 ) {
    hour = checkTime(hour);
  document.getElementById("wtf").innerHTML = hour+":"+minute+":"+ss+" AM";
  }
  else {
    hour = checkTime(hour);
    document.getElementById("wtf").innerHTML = hour+":"+minute+":"+ss+" PM";
  }
}
else {
  document.getElementById("wtf").innerHTML = hour+":"+minute+":"+ss+" AM";;
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                                ...
                                <h3 class="w3-header">Healthy tips</h3>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="images/image1.jpg" width="1000" height="100"alt="Los Angeles" >
      </div>

      <div class="item">
        <img src="images/image2.jpg" width="1000" height="100"alt="Chicago" >
      </div>
    
      <div class="item">
        <img src="images/image3.jpg" width="1000" height="100"alt="New york" >
      </div>
    </div>
