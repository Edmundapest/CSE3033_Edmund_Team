...
session_start();
 ...
 {  
      ...
      $output = '';  
      $conn = mysqli_connect("localhost", "root", "qwerty123", "breathe");  
      $sql = "SELECT username,activities,ActStart,ActEnd,category FROM task WHERE username='$username' ORDER BY ActID ASC";  
 ...
 {  
      ...
      $content = '';  
      $content .= '  
      <h4 align="center">Timetable PDF</h4><br /> 
      <table border="1" cellspacing="0" cellpadding="3">  
           <tr>  
                <th width="10%">Name</th>  
                <th width="20%">Activities</th>  
                <th width="20%">StartDate&Time</th>  
                <th width="20%">EndDate&Time</th> 
